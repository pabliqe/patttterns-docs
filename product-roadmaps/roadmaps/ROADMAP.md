...
- Cache and artifact flow: [CACHE_PIPLINE](../../build-and-deploy/setup/CACHE_PIPLINE)
- Auth and login behavior: [AUTH_SETUP](../../build-and-deploy/setup/AUTH_SETUP), [LOGIN_FLOW](../../build-and-deploy/setup/LOGIN_FLOW)
...
Ver [ROADMAP_SOCIAL_LOGINS.md](../archive/ROADMAP_SOCIAL_LOGINS) para el plan detallado de Social Login, Cloud Sync y Plan Pro.