...
### 4) public/og/covers/*.jpg + manifest.json
...
- served as static `/og/covers/{id}.jpg`
...
- `build-og-images` — letterbox GIF covers to JPEG for social (committed under `public/og/covers/`)
